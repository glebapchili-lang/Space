...
public class GameResources {
    ...
    public static  String SHIP_IMG_PATH = "textures/ship.png";

    public static  String SHIP1_IMG = "textures/jet1.png";

    public static  String SHIP2_IMG = "textures/cosm2.png";
    public static String SHIP3_IMG = "textures/jet3.png";
