...
public class MenuScreen extends ScreenAdapter {
    ...
    public MenuScreen(MyGdxGame myGdxGame) {
        ...
        skinsButtonView = new ButtonView(140, 456, 440, 70, myGdxGame.commonBlackFont, GameResources.BUTTON_LONG_BG_IMG_PATH, "skins");
    ...
    public void render(float delta) {
        ...
        skinsButtonView.draw(myGdxGame.batch);
    ...
    private void handleInput() {
        if (Gdx.input.justTouched()) {
            ...
            if (skinsButtonView.isHit(myGdxGame.touch.x, myGdxGame.touch.y)) {
